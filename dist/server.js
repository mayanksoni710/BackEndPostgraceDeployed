...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"sequelize\", function() { return sequelize; });\n/* harmony import */ var sequelize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sequelize */ \"sequelize\");\n/* harmony import */ var sequelize__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sequelize__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config */ \"./src/database/config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _models_users_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/users.model */ \"./src/database/models/users.model.js\");\n/* harmony import */ var _models_products_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/products.model */ \"./src/database/models/products.model.js\");\n/* harmony import */ var _models_categories_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/categories.model */ \"./src/database/models/categories.model.js\");\n/* eslint-disable no-console */\n\n\n\n\n\nvar _dbConfig$conStr = _config__WEBPACK_IMPORTED_MODULE_1___default.a.conStr,\n    conStr = _dbConfig$conStr === void 0 ? '' : _dbConfig$conStr;\nvar sequelize = new sequelize__WEBPACK_IMPORTED_MODULE_0___default.a(conStr);\nsequelize.authenticate().then(function () {\n  console.log('Connection has been established successfully.');\n})[\"catch\"](function (err) {\n  console.error('Unable to connect to the database:', err);\n});\nvar models = {\n  Users: Object(_models_users_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(sequelize, sequelize__WEBPACK_IMPORTED_MODULE_0___default.a),\n  Products: Object(_models_products_model__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(sequelize, sequelize__WEBPACK_IMPORTED_MODULE_0___default.a),\n  Categories: Object(_models_categories_model__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(sequelize, sequelize__WEBPACK_IMPORTED_MODULE_0___default.a)\n};\nObject.keys(models).forEach(function (key) {\n  if ('associate' in models[key]) {\n    models[key].associate(models);\n  }\n});\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (models);\n\n//# sourceURL=webpack:///./src/database/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../database */ \"./src/database/index.js\");\n/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utilities */ \"./src/utilities.js\");\n/* harmony import */ var _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants/StaticConstants */ \"./src/constants/StaticConstants.js\");\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\nvar Users = _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].Users;\nvar router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\nrouter.get('/:userId', function (req, res, next) {\n  var _req$params = req.params;\n  _req$params = _req$params === void 0 ? {} : _req$params;\n  var _req$params$userId = _req$params.userId,\n      id = _req$params$userId === void 0 ? -1 : _req$params$userId;\n  Users.findAll({\n    where: {\n      id: id\n    }\n  }).then(function (response) {\n    if (response) res.status(200).json(response);else next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(200, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_NOT_FOUND\"]));\n  })[\"catch\"](function () {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(400, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_ID_INVALID\"]));\n  });\n});\nrouter.get('/', function (req, res, next) {\n  Users.findAll().then(function (response) {\n    if (response) res.status(200).json(response);else next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(200, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_NOT_FOUND\"]));\n  })[\"catch\"](function () {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(400, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_ID_INVALID\"]));\n  });\n});\nrouter[\"delete\"]('/:userId?', function (req, res, next) {\n  var _req$params2 = req.params;\n  _req$params2 = _req$params2 === void 0 ? {} : _req$params2;\n  var _req$params2$userId = _req$params2.userId,\n      id = _req$params2$userId === void 0 ? -1 : _req$params2$userId;\n\n  if (id === -1) {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(200, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_ID_MISSING\"]));\n    return;\n  }\n\n  Users.destroy({\n    where: {\n      id: id\n    }\n  }).then(function () {\n    res.status(200).send({\n      message: _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_DELETED_SUCCESSFULLY\"]\n    });\n  })[\"catch\"](function () {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(400, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"ERROR_DELETING_USER\"]));\n  });\n});\nrouter.post('/', function (req, res, next) {\n  var _req$body = req.body,\n      _req$body$name = _req$body.name,\n      name = _req$body$name === void 0 ? -1 : _req$body$name,\n      _req$body$gender = _req$body.gender,\n      gender = _req$body$gender === void 0 ? -1 : _req$body$gender,\n      _req$body$age = _req$body.age,\n      age = _req$body$age === void 0 ? -1 : _req$body$age,\n      _req$body$email = _req$body.email,\n      email = _req$body$email === void 0 ? -1 : _req$body$email,\n      _req$body$address = _req$body.address,\n      address = _req$body$address === void 0 ? -1 : _req$body$address;\n  Users.create({\n    name: name,\n    gender: gender,\n    age: age,\n    email: email,\n    address: address\n  }).then(function (response) {\n    res.status(200).json({\n      message: _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_ADDED_SUCCESSFULLY\"],\n      DataAdded: response\n    });\n  })[\"catch\"](function () {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(400, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"ERROR_ADDING_USER\"]));\n  });\n});\nrouter.put('/:userId?', function (req, res, next) {\n  var _req$params3 = req.params;\n  _req$params3 = _req$params3 === void 0 ? {} : _req$params3;\n  var _req$params3$userId = _req$params3.userId,\n      id = _req$params3$userId === void 0 ? -1 : _req$params3$userId,\n      _req$body2 = req.body,\n      _req$body2$name = _req$body2.name,\n      name = _req$body2$name === void 0 ? -1 : _req$body2$name,\n      _req$body2$gender = _req$body2.gender,\n      gender = _req$body2$gender === void 0 ? -1 : _req$body2$gender,\n      _req$body2$age = _req$body2.age,\n      age = _req$body2$age === void 0 ? -1 : _req$body2$age,\n      _req$body2$email = _req$body2.email,\n      email = _req$body2$email === void 0 ? -1 : _req$body2$email,\n      _req$body2$address = _req$body2.address,\n      address = _req$body2$address === void 0 ? -1 : _req$body2$address;\n  var detailsToUpdate = {};\n\n  if (id === -1) {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(200, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_ID_MISSING\"]));\n    return;\n  }\n\n  if (name !== -1) {\n    detailsToUpdate = _objectSpread({}, detailsToUpdate, {\n      name: name\n    });\n  }\n\n  if (gender !== -1) {\n    detailsToUpdate = _objectSpread({}, detailsToUpdate, {\n      gender: gender\n    });\n  }\n\n  if (age !== -1) {\n    detailsToUpdate = _objectSpread({}, detailsToUpdate, {\n      age: age\n    });\n  }\n\n  if (email !== -1) {\n    detailsToUpdate = _objectSpread({}, detailsToUpdate, {\n      email: email\n    });\n  }\n\n  if (address !== -1) {\n    detailsToUpdate = _objectSpread({}, detailsToUpdate, {\n      address: address\n    });\n  }\n\n  Users.update(_objectSpread({}, detailsToUpdate), {\n    where: {\n      id: id\n    }\n  }).then(function () {\n    res.status(200).send({\n      message: _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"USER_UPDATED_SUCCESSFULLY\"]\n    });\n  })[\"catch\"](function () {\n    next(Object(_utilities__WEBPACK_IMPORTED_MODULE_2__[\"createError\"])(400, _constants_StaticConstants__WEBPACK_IMPORTED_MODULE_3__[\"ERROR_UPDATING_USER\"]));\n  });\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./src/routes/users.js?");
